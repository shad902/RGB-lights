...
{
	if ( PTD->PDIR & (1ul << (1 + switch_no))) //use (1ul << (1 + switch_no)) as a mask. if we are looking for switch 1, then the mask is (1ul << 3), and if we are looking for switch 2, then the mask is (1ul << 4)
	{
